...
tryCatch(
  {
    # The locations table has columns for 'latitude', 'longitude', and visibility if RLS protected. In some cases though rows should be visible but with the exact location obfuscated.

    # Some database functions also need to be adjusted, at least get_csw_layer().

    # What about location_metadata views?
