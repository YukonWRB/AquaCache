...
predictMissing_mice <- function(tsid, radius, predict_range, train_range = NULL, extra_params = NULL, imputed = TRUE, daily = FALSE, mice = FALSE, con = hydrometConnect(silent = TRUE)) {
