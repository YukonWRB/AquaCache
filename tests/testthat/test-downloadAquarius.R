...
test_that("downloadAquarius fetches data", {
  ...
  res <- downloadAquarius(location = "TEST", parameter = "Air Temp.Temperature", start_datetime = start_dt, end_datetime = end_dt, login = c("readonly", "WaterIsLife"), server = "https://yukon.aquaticinformatics.net/AQUARIUS", con)
