...
updateHydrometDocument <- function(
  id,
  new_path = NULL,
  new_name = NULL,
  new_type = NULL,
  ...
  new_authors = NULL,
  new_publish_date = NULL,
  new_url = NULL,
  new_user_groups = NULL,
  new_geoms = NULL,
  con = AquaConnect(),
  check = TRUE
) {
  ...
  if (nrow(id_exists) == 0) {
    ...
    if (check) {
      ...
      message <- paste0(
        "The document you are about to update has the following attributes:\n  Name: ",
        id_exists$name,
        "\n  Type: ",
        id_exists$type,
        "\n  Authors: ",
        ...
        id_exists$url,
        "\n  Publish Date: ",
        id_exists$publish_date,
        "\n  Description: ",
        id_exists$description,
  ...
  if (!is.null(new_type)) {
    assigned_type <- db_types$document_type_id[
      db_types$document_type_en == new_type
    ]
    DBI::dbExecute(
      con,
      paste0(
