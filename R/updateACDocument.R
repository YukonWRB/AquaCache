...
updateHydrometDocument <- function(id, new_path = NULL, new_name = NULL, new_type = NULL, new_description = NULL, new_authors = NULL, new_publish_date = NULL, new_url = NULL, new_public = NULL, new_geoms = NULL, con = AquaCacheCon(), check = TRUE) {
