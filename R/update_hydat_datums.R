...
# this function could be trigered if there is a new hydat (see fx update_hydat) or on demand. Should NOT delete entries that are not in the new hydat, unless they are not in use in the DB anywhere, since these may have been added by a user for a specific purpose.
