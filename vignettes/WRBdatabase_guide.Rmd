...
# file.copy(from = paste0(dirname(getwd()), "/doc/WRBdatabase_guide.html"), to = "//env-fs/env-data/corp/water/Common_GW_SW/R-packages/WRBdatabase/WRBdatabase user guide.html", overwrite = TRUE)
```
